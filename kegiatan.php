      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <!-- Card Body -->
            <div class="card-body">
              <center><h5 class="mb-5"><b>Tambah Pasien</b></h5></center>
              ...
              <input class="form-control form-control-sm" type="number" placeholder="Kode Unit..." aria-label=".form-control-sm example" name='nick' required>
              </div>

                <div class="col-sm-4">
              <label>Jenis Unit:</label>
              <input class="form-control form-control-sm" type="text" placeholder="Jenis Unit..." aria-label=".form-control-sm example" name='nama' required>
              </div>
                ...
                <div class="col-sm-4">
                  ...
                  <select class="form-control" name='gender' required>
                    <option selected disabled value="">Kelamin...</option>
              ...
              <div class="col-sm-4">
                ...
                <input class="form-control form-control-sm" type="text" placeholder="Tahun Pembuatan..." aria-label=".form-control-sm example" name='alamat' required>
              </div>
              ...
              <input class="form-control form-control-sm" type="text" placeholder="Keterangan..." aria-label=".form-control-sm example" name='nama' required>
              </div>
              ...
              <div class="row mt-3">
                <div class="col-sm-4">
              <label>Merek:</label>
              <input class="form-control form-control-sm" type="number" placeholder="Merek..." aria-label=".form-control-sm example" name='nick' required>
              </div>
              </div>
              ...
              <div class="row mt-3">
                <div class="col-sm-4">
              <label>Seri:</label>
              <input class="form-control form-control-sm" type="number" placeholder="Seri..." aria-label=".form-control-sm example" name='nick' required>
              </div>
              </div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; <a href="https://www.youtube.com/channel/UCIWwjyb6lAh-Xv_TvhGDnoA" style="text-decoration: none;"><b>Arfanda Putra</b></a></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
