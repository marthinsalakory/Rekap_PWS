...
if ($_SESSION['role'] != 'admin' && $_SESSION['role'] != 'pekerja1' && $_SESSION['role'] != 'pekerja2' && $_SESSION['role'] != 'pekerja3') {
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          if ($ggl) {
            ...
            $det = mysqli_query($conn, "select * from kegiatan where id='$id_brg'");
          ...
          ?>
                ...
                <form method="post" name='edit'>
                  <div class="row ml-5 mb-2 mt-3">
                    <div class="col-md-6">
                      ...
                      <P><b>Tanggal:</b></p>
                      <input class="form-control" type="text" name='tanggal' placeholder="Tanggal..." value="<?php echo $d['tanggal']; ?>" required>

                      <P><b>Operator:</b></p>
                      <input class="form-control" type="text" name='operator' placeholder="Operator..." value="<?php echo $d['operator']; ?>" required>

                      <P><b>Helper:</b></p>
                      <input class="form-control" type="text" name='helper' placeholder="Helper..." value="<?php echo $d['helper']; ?>" required>

                      <P><b>Jenis Aktifitas:</b></p>
                      <input class="form-control" type="text" name='jenis_aktifitas' placeholder="Jenis Aktifitas..." value="<?php echo $d['jenis_aktifitas']; ?>" required>


                      <P><b>Jenis Unit:</b></p>
                      <input class="form-control" type="text" name='jenis_unit' value="<?php echo $d['jenis_unit']; ?>" placeholder="Jenis Unit..." required>

                      <P><b>Dari Jam:</b></p>
                      <input class="form-control" type="text" name='dari_jam' placeholder="Dari jam..." value="<?php echo $d['dari_jam']; ?>" required>

                      <P><b>Sampai Jam:</b></p>
                      <input class="form-control" type="text" name='sampai_jam' placeholder="Sampai jam..." value="<?php echo $d['sampai_jam']; ?>" required>

                      <P><b>Lokasi:</b></p>
                      <input class="form-control" type="text" name='lokasi' placeholder="Lokasi..." value="<?php echo $d['lokasi']; ?>" required>
            ...
            if (isset($_POST['edit'])) {
              ...
              $edit = mysqli_query($conn, "UPDATE kegiatan SET

              tanggal ='$tanggal',
              operator ='$operator',
              helper ='$helper',
              jenis_aktifitas ='$jenis_aktifitas',
