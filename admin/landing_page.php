...
-->
    ...
    <link rel="stylesheet" type="text/css" href="assets2/css/templatemo-art-factory.css">
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="#" class="logo">Sistem Informasi Laporan Pemakaian Alat Berat</a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            ...
                            <li><a target="" href="lokasi.php">Lokasi</a></li>
                            <li><a target="" href="login.php">Login</a></li>
                            <!--           <li class="divider"></li> -->

                            <!-- <li target="" href="lokasi.php"></li> -->
                            <!-- <li class="submenu">
                                <a href="javascript:;" class="active">LOGIN</a>
                                <ul id="dropdown" class="dropdown-content">
                                    <li><a target="" href="login.php">Admin</a></li>
                                    <li><a target="" href="login1.php">Pekerja</a></li>
                                    <li><a target="" href="login3.php">Pekerja</a></li>
                                    <li><a target="" href="login4.php">Pekerja</a></li>
                                    <li><a target="" href="login2.php">Pimpinan</a></li>
                                    <li class="divider"></li>
    ...
    <div class="welcome-area" id="welcome">
        ...
        <div class="header-text">
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 100px over 0.6s after 0.6s">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                        <img src="img/pws_logo.png" class="rounded img-fluid d-block mx-auto" alt="First Vector Graphic">
                    </div>
                </div>
            </div>
        </div>
