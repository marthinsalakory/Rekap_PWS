            ...
            <div class="card-body">
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-4 mt-5 ">
                  <form class="form-inline my-2 my-lg-0" action="cari_operator2.php" method="get" name='cari'>
              ...
              <div class="table-responsive service">
                <table class="table table-bordered table-hover  mt-3 text-nowrap css-serial">
                  ...
                  if (isset($_GET['cari'])) {
                    ...
                    $brg = mysqli_query($conn, "select * from operator orders limit $start, $hal");
                  }
