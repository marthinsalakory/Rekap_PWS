      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          if ($ggl) {
            ...
            $det = mysqli_query($conn, "select * from operator where id='$id_brg'") or die(mysql_error());
          ...
          ?>
                  ...
                  <div class="row ml-5">
                    <div class="col-md-10 col-sm-12 col-xs-12">
                      ...
                      <table class="table">
                        ...
                        <tr>
                          <td>Kode Operator:</td>
                          <td><?php echo $d['kode_operator']; ?></td>
                        </tr>
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <a href="tab_operator.php"><button type="button" class="btn btn-info">Kembali Lagi</button></a>
                </div>
