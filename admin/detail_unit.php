      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          if ($ggl) {
            ...
            $det = mysqli_query($conn, "select * from unit where id='$id_brg'") or die(mysql_error());
          ...
          ?>
              ...
              <div class="card shadow mb-4">
                ...
                <td><?php echo $d['hm']; ?></td>
                        ...
                        <tr>
                          ...
                          <td><?php echo $d['tanggal_pembuatan']; ?></td>
                        </tr>
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <a href="tab_unit.php"><button type="button" class="btn btn-info">Kembali Lagi</button></a>
                </div>
