          ...
          <div class="row mt-5">
            ...
            <div class="col-xl-12 col-lg-8">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <center>
                    <h5 class="mb-5"><b>Input Data Unit</b></h5>
                  </center>
                  ...
                  <form action='' name='submit' method='post'>
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        ...
                        <input class="form-control form-control-sm" type="number" placeholder="Tahun Pembuatan..." aria-label=".form-control-sm example" name='tanggal_pembuatan' required>
                      </div>
                    </div>
                    ...
                    <div class="row mt-3">
                      <div class="col-sm-4">
                        <label>Merek:</label>
                        <input class="form-control form-control-sm" type="text" placeholder="Merek..." aria-label=".form-control-sm example" name='merek' required>
                      </div>
                    </div>
                    ...
                    <div class="row mt-3">
                      <div class="col-sm-4">
                        <label>Seri:</label>
                        <input class="form-control form-control-sm" type="text" placeholder="Seri..." aria-label=".form-control-sm example" name='seri' required>
                      </div>
                    </div>
                    ...
                    <div class="row mt-3">
                      <div class="col-sm-4">
                        ...
                        <textarea class="form-control form-control-sm" type="text" placeholder="Keterangan..." aria-label=".form-control-sm example" name='keterangan' required>
              </textarea>
                      </div>
                    </div>
                  ...
                  if (isset($_POST['submit'])) {
                    ...
                    $wet = mysqli_query($conn, "select * from unit where kode_unit ='$kode_unit' and jenis_unit='$jenis_unit' and merek ='$merek' and seri='$seri' and tanggal_pembuatan='$tanggal_pembuatan' and keterangan='$keterangan'");
                    ...
                    if ($chak > 0) {
                      ...
                      $merek === $rew['merek'];
                      $seri === $rew['seri'];
                      $tanggal_pembuatan === $rew['tanggal_pembuatan'];
                      ...
                      $insert = mysqli_query($conn, "INSERT INTO unit VALUES (
      NULL,
      '$kode_unit',
      '$jenis_unit',
      '$merek',
