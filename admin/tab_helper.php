      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="tab_helper.php">Tabel Helper</a>
            ...
            <div class="card-body">
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-8  mt-4">
                  ...
                  <a href="export_operator.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-1"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>

                </div>

                <div class="col-md-4 mt-5 ">
                  <form class="form-inline my-2 my-lg-0" action="cari_operator.php" method="get" name='cari'>
              ...
              <div class="table-responsive service">
                <table class="table table-bordered table-hover  mt-3 text-nowrap css-serial">
                  ...
                  if (isset($_GET['cari'])) {
                    ...
                    $brg = mysqli_query($conn, "select * from helper where tanggal like '%" . $cari . "%' or kode_helper like '%" . $cari . "%' or nama1 like '%" . $cari . "%' or jenis_unit1 like '%" . $cari . "%' or hm1 like '%" . $cari . "%' or jabatan1 like '%" . $cari . "%'");
                    ...
                    $brg = mysqli_query($conn, "select * from helper orders limit $start, $hal");
                  }
                  ...
                  ?>
                      <tbody>
                        <tr>
                          ...
                          <td><?php echo $row['kode_helper'] ?></td>
                          <td><?php echo $row['nama1'] ?></td>
                          <td><?php echo $row['jenis_unit1'] ?></td>
                          <td><?php echo $row['hm1'] ?></td>
                          <td><?php echo $row['jabatan1'] ?></td>


                          <td>&nbsp;<a href="edit_helper.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Edit</button></a> &nbsp; <a href="hapus_operator.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a> &nbsp; <a href="detail_operator.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-info">Detail</button></a></td>
