      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          if ($ggl) {
            ...
            $det = mysqli_query($conn, "select * from kegiatan where id='$id_brg'") or die(mysql_error());
                ...
                <div class="card-body">
                  ...
                  <div class="row ml-5">
                    <div class="col-md-10 col-sm-12 col-xs-12">
                      <h2>
                        <center>Info Detail Aktivitas</center>
                      </h2>
                      <table class="table">
                        ...
                        <tr>
                          <td>Helper:</td>
                          <td><?php echo $d['helper']; ?></td>
                        </tr>

                        <tr>
                          <td>Jenis Aktivitas:</td>
                          <td><?php echo $d['jenis_aktifitas']; ?></td>
                        </tr>

                        <tr>
                          <td>Jenis Unit:</td>
                          <td><?php echo $d['jenis_unit']; ?></td>
                        </tr>
