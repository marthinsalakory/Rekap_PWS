            ...
            <div class="card-body">
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-4 mt-5 ">
                  <form class="form-inline my-2 my-lg-0" action="cari_kegiatan.php" method="get" name='cari'>
                    <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name='cari' required>
                    <button class="btn btn-outline-success my-2 my-sm-0" type="cari">Search</button>
                  </form>
                </div>
              ...
              <div class="table-responsive service">
                <table class="table table-bordered table-hover  mt-3 text-nowrap css-serial">
                  ...
                  if (isset($_GET['cari'])) {
                    ...
                    $brg = mysqli_query($conn, "select * from kegiatan where tanggal like '%" . $cari . "%' or jenis_aktivitas like '%" . $cari . "%' or jenis_unit like '%" . $cari . "%' or dari_jam like '%" . $cari . "%' or sampai_jam like '%" . $cari . "%' or lokasi like '%" . $cari . "%' or aktivitas like '%" . $cari . "%'   ");
