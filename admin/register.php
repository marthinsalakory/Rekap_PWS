          ...
          <div class="row mt-5">
            ...
            <div class="col-xl-12 col-lg-8">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <center>
                    <h5 class="mb-5"><b>Tambah Akun Baru Pekerja</b></h5>
                  </center>
                  ...
                  <form action='' name='register' method='post'>
                    ...
                    <div class="row mt-3">
                      <div class="col-sm-4">
                        ...
                        <input class="form-control form-control-sm" type="text" placeholder="New Username..." aria-label=".form-control-sm example" name='username' required>
                      </div>
                    </div>
                    ...
                    <div class="row mt-3">
                      <div class="col-sm-4">
                        ...
                        <input class="form-control form-control-sm" type="text" placeholder="New Password..." aria-label=".form-control-sm example" name='password' required>
                      </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-info btn-lg btn-block mt-4" name='register'>Register new Account</button>
                  ...
                  if (isset($_POST['register'])) {
                    ...
                    $wet = mysqli_query($conn, "select * from pekerja where username ='$username' and password='$password'");
                    ...
                    if ($chak > 0) {
                      ...
                      echo "<p><center>Data Operator sudah tersedia</center></p>";
                      echo   "</div>";
                      echo "</div>";
                    } else {
                      ...
                      $insert = mysqli_query($conn, "INSERT INTO pekerja VALUES (
