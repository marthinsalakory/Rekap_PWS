              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <form action='' name='submit' method='post'>
                    <input type="hidden" name="role" value="p1">
                    <div class="row">
                      <div class="col-sm-4">
                    ...
                    <div class="row mt-3">
                      <div class="col-sm-4" name="operator">
                        ...
                        <select name="operator">
                          ...
                          <?php
                          $query = "SELECT nama FROM operator WHERE role = 'p1'  GROUP BY nama";
                    ...
                    <div class="row mt-3">
                      <div class="col-sm-4" name="helper">
                        ...
                        <select name="helper">
                          ...
                          <?php
                          $query = "SELECT nama_helper FROM operator WHERE role = 'p1'  GROUP BY nama_helper";
                          $sql = mysqli_query($conn, $query);
                    ...
                    <div class="row mt-3">
                      <div class="col-sm-4" name="jenis_unit">
                        ...
                        <select name="jenis_unit">
                          ...
                          <?php
                          $query = "SELECT jenis_unit FROM operator WHERE role = 'p1' GROUP BY jenis_unit";
                          $sql = mysqli_query($conn, $query);
