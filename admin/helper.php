          ...
          <div class="row mt-5">
            ...
            <div class="col-xl-12 col-lg-8">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <center>
                    <h5 class="mb-5"><b>Input Data Helper</b></h5>
                  </center>
                  ...
                  <form action='' name='submit' method='post'>
                    ...
                    <div class="row mt-3">
                      ...
                      <div class="col-sm-4">
                        <label>Kode Helper:</label>
                        <input class="form-control form-control-sm" type="text" placeholder="Kode Helper..." aria-label=".form-control-sm example" name='kode_helper' required>
                      </div>
                    ...
                    <div class="row mt-3">
                      <div class="col-sm-4">
                        <label>Nama:</label>
                        <input class="form-control form-control-sm" type="text" placeholder="Nama..." aria-label=".form-control-sm example" name='nama1' required>
                      </div>
                    </div>
                    ...
                    <div class="row mt-3">
                      <div class="col-sm-4">
                        ...
                        <input class="form-control form-control-sm" type="text" placeholder="Jenis Unit..." aria-label=".form-control-sm example" name='jenis_unit1' required>
                      </div>
                    </div>
                    ...
                    <div class="row mt-3">
                      <div class="col-sm-4">
                        ...
                        <input class="form-control form-control-sm" type="text" placeholder="H/m..." aria-label=".form-control-sm example" name='hm1' required>
                      </div>
                    </div>
                    ...
                    <div class="row mt-3">
                      <div class="col-sm-4">
                        <label>Jabatan:</label>
                        <input class="form-control form-control-sm" type="text" placeholder="Jabatan..." aria-label=".form-control-sm example" name='jabatan1' required>
                      </div>
                    </div>
                  ...
                  if (isset($_POST['submit'])) {
                    ...
                    $kode_helper = htmlspecialchars($_POST['kode_helper']);
                    $nama1 = htmlspecialchars($_POST['nama1']);
                    $jenis_unit1 = htmlspecialchars($_POST['jenis_unit1']);
                    $hm1 = htmlspecialchars($_POST['hm1']);
                    ...
                    $wet = mysqli_query($conn, "select * from helper where tanggal ='$tanggal' and kode_helper ='$kode_helper' and nama1='$nama1' and jenis_unit1 ='$jenis_unit1' and hm1 ='$hm1' and jabatan1='$jabatan1'");
                    $chak = mysqli_num_rows($wet);
                    if ($chak > 0) {

                      $rew = mysqli_fetch_array($wet);
                      $tanggal === $rew['tanggal'];
                      $kode_helper === $rew['kode_helper'];
                      $nama1 === $rew['nama1'];
                      $jenis_unit1 === $rew['jenis_unit1'];
                      $hm1 === $rew['hm1'];
                      $jabatan1 === $rew['jabatan1'];
                      ...
                      $insert = mysqli_query($conn, "INSERT INTO helper VALUES (
  NULL,
  '$tanggal',
  '$kode_helper',
  '$nama1',
