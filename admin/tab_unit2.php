      ...
      <!--       <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="timesheet1.php">Timesheet: </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $rrr['nama2']; ?></span>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              $jumlah_cos = mysqli_query($conn, "SELECT COUNT(*) as id from unit");
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-8  mt-4">
                  ...
                  <a href="export_unit.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-1"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                ...
                <div class="col-md-4 mt-5 ">
                  <form class="form-inline my-2 my-lg-0" action="cari_unit2.php" method="get" name='cari'>
                ...
                <table class="table table-bordered table-hover  mt-3 text-nowrap css-serial">
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Keterangan Pekerja</th>
                  ...
                  if (isset($_GET['cari'])) {
                    ...
                    $brg = mysqli_query($conn, "select * from unit where kode_unit like '%" . $cari . "%' or jenis_unit like '%" . $cari . "%' or merek like '%" . $cari . "%' or seri like '%" . $cari . "%' or tanggal_pembuatan like '%" . $cari . "%' or keterangan like '%" . $cari . "%'");
                    ...
                    $brg = mysqli_query($conn, "select * from unit orders limit $start, $hal");
                  }
                  ...
                  ?>
                      <tbody>
                        <tr>
                          ...
                          <th scope="row"><?php echo $row['tanggal_pembuatan'] ?></th>
                          ...
                          <td>&nbsp;<a href="edit_unit.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Edit</button></a> &nbsp; <a href="hapus_unit.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a> &nbsp; <a href="detail_unit.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-info">Detail</button></a></td>
