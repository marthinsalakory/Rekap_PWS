      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          if ($ggl) {
            ...
            $det = mysqli_query($conn, "select * from timesheet where id='$id_brg'") or die(mysql_error());
          ...
          ?>
                  ...
                  <div class="row ml-5">
                    <div class="col-md-10 col-sm-12 col-xs-12">
                      ...
                      <table class="table">
                        ...
                        <tr>
                          <td>Dari Jam:</td>
                          <td><?php echo $d['dari_jam']; ?></td>
                        </tr>

                        <tr>
                          <td>Sampai Jam:</td>
                          <td><?php echo $d['sampai_jam']; ?></td>
                        </tr>

                        <tr>
                          <td>Jam Konversi:</td>
                          <td><?php echo $d['jam_konversi']; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><?php echo $d['lokasi_pekerjaan']; ?></td>
                        </tr>
                        <tr>
                          <td>H/m Awal:</td>
                          <td><?php echo $d['hm_awal']; ?></td>
                        </tr>
                        <tr>
                          <td>H/m Akhir:</td>
                          <td><?php echo $d['hm_akhir']; ?></td>
                        </tr>
                        <tr>
                          <td>H/m K/m:</td>
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <a href="tab_timesheet.php"><button type="button" class="btn btn-info">Kembali Lagi</button></a>
                </div>
