      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          if ($ggl) {
            ...
            $det = mysqli_query($conn, "select * from timesheet where id='$id_brg'");
          ...
          ?>
                ...
                <form method="post" name='edit'>
                  <div class="row ml-5 mb-2 mt-3">
                    <div class="col-md-6">
                      ...
                      <P><b>Tanggal:</b></p>
                      <input class="form-control" type="date" name='tanggal' placeholder="Tanggal..." value="<?php echo $d['tanggal']; ?>" required>


                      <P><b>Kode Unit:</b></p>
                      <input class="form-control" type="text" name='kode_unit' value="<?php echo $d['kode_unit']; ?>" placeholder="Kode Unit..." required>

                      <P><b>Operator:</b></p>
                      <input class="form-control" type="text" name='operator' value="<?php echo $d['operator']; ?>" placeholder="Operator..." required>

                      <P><b>Dari Jam:</b></p>
                      <input class="form-control" type="text" name='dari_jam' value="<?php echo $d['dari_jam']; ?>" placeholder="Dari Jam..." required>

                      <P><b>Sampai Jam:</b></p>
                      <input class="form-control" type="text" name='sampai_jam' value="<?php echo $d['sampai_jam']; ?>" placeholder="Sampai Jam..." required>

                      <P><b>Jam Konversi:</b></p>
                      <input class="form-control" type="text" name='jam_konversi' value="<?php echo $d['jam_konversi']; ?>" placeholder="Jam Konversi..." required>

                      <P><b>Jenis Aktivitas:</b></p>
                      <input class="form-control" type="text" name='jenis_aktivitas' value="<?php echo $d['jenis_aktivitas']; ?>" placeholder="Jenis Aktivitas..." required>

                      <P><b>Aktivitas:</b></p>
                      <input class="form-control" type="text" name='aktivitas' value="<?php echo $d['aktivitas']; ?>" placeholder="Aktivitas..." required>

                      <P><b>Lokasi Pekerjaan:</b></p>
                      <input class="form-control" type="text" name='lokasi_pekerjaan' value="<?php echo $d['lokasi_pekerjaan']; ?>" placeholder="Lokasi Pekekerjaan..." required>

                      <P><b>H/m Awal:</b></p>
                      <input class="form-control" type="text" name='hm_awal' value="<?php echo $d['hm_awal']; ?>" placeholder="H/m Awal..." required>

                      <P><b>H/m Akhir:</b></p>
                      <input class="form-control" type="text" name='hm_akhir' value="<?php echo $d['hm_akhir']; ?>" placeholder="H/m Akhir..." required>

                      <P><b>H/m K/m:</b></p>
                      <input class="form-control" type="text" name='hm_km' value="<?php echo $d['hm_km']; ?>" placeholder="H/m K/m..." required>
            ...
            if (isset($_POST['edit'])) {
              ...
              $edit = mysqli_query($conn, "UPDATE timesheet SET
