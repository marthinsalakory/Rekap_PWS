      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          if ($ggl) {
            ...
            $det = mysqli_query($conn, "select * from unit where id='$id_brg'");
          ...
          ?>
                ...
                <form method="post" name='edit'>
                  <div class="row ml-5 mb-2 mt-3">
                    <div class="col-md-6">
                      ...
                      <P><b>Merek:</b></p>
                      <input class="form-control" type="text" name='merek' placeholder="Edit Merek..." value="<?php echo $d['merek']; ?>" required>


                      <P><b>Seri:</b></p>
                      <input class="form-control" type="text" name='seri' value="<?php echo $d['seri']; ?>" placeholder="Edit Seri..." required>

                      <P><b>Tahun Pembuatan:</b></p>
                      <input class="form-control" type="text" name='tanggal_pembuatan' placeholder="Edit Tanggal..." value="<?php echo $d['tanggal_pembuatan']; ?>" required>

                      <P><b>Keterangan Pekerja:</b></p>
                      <input class="form-control" type="text" name='keterangan' placeholder="Edit Keterangan..." value="<?php echo $d['keterangan']; ?>" required>
                  ...
                  <div class="row ml-5 mb-4 mt-3">
                    ...
                    <div class="col-md-5">
                      <button type="submit" class="btn btn-info" name='edit'>Edit</button>&nbsp;<input type="reset" class="btn btn-danger" value="Reset">
                    </div>
            ...
            if (isset($_POST['edit'])) {
              ...
              $edit = mysqli_query($conn, "UPDATE unit SET        
          kode_unit = '$kode_unit',
