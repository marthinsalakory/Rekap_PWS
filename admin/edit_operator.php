      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          if ($ggl) {
            ...
            $det = mysqli_query($conn, "select * from operator where id='$id_brg'");
            while ($d = mysqli_fetch_array($det)) {
          ?>
              <div class="card shadow  ml-4 mr-4">
                <div class="card-header py-3">
                  <h1 class="h3 mb-0 text-gray-800">Edit Data Operator</h1>
                </div>
                ...
                <form method="post" name='edit'>
                  <div class="row ml-5 mb-2 mt-3">
                    <div class="col-md-6">
                      ...
                      <P><b>H/m:</b></p>
                      <input class="form-control" type="text" name='hm' value="<?php echo $d['hm']; ?>" placeholder="H/m..." required>
            ...
            if (isset($_POST['edit'])) {
              ...
              $edit = mysqli_query($conn, "UPDATE operator SET
