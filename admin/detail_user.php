            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    if ($ggl) {
                        ...
                        $det = mysqli_query($conn, "select * from users where id='$id'") or die(mysql_error());
                    ...
                    ?>
                                    ...
                                    <div class="row ml-5">
                                        <div class="col-md-10 col-sm-12 col-xs-12">
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td><img width="200px" height="200px" src="img/<?= $d['foto']; ?>" alt="<?= $d['foto']; ?>"></td>
                                                </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <a href="tab_pengguna.php"><button type="button" class="btn btn-info">Kembali Lagi</button></a>
                                </div>
